...
def generate_launch_description():
    ...
    bot = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([os.path.join(
            description_pkg, 'launch', 'description_sim.launch.py'
    ...
    gazebo_params_file = os.path.join(get_package_share_directory(
        'black_donut_gazebo'), 'config', 'gazebo_params.yaml')
    ...
    spawn_robot_node = Node(
        ...
        arguments=['-file', urdf_file, '-entity', 'donut_sim_robot.urdf.xacro',
                   "-x", '0.0',
                   "-y", '0.0',
                   "-z", '0.3'],
        output='screen'
