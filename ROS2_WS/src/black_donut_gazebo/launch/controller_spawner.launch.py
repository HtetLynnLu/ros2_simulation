...
def generate_launch_description():
    ...
    xacro_file = os.path.join(urdf_pkg,'urdf', 'ros2_sim_contorl.urdf.xacro')
    robot_description_config = xacro.process_file(xacro_file)

    params = {'black_donut_description': robot_description_config.toxml(), 'use_sim_time': use_sim_time}
